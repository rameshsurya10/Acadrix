    ...
    <div className="bg-surface text-on-surface min-h-screen">
      ...
      <aside className="hidden md:flex flex-col border-r border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 h-screen w-64 fixed left-0 top-0 z-50">
        <div className="px-6 py-8">
          <span className="text-lg font-black text-blue-900 dark:text-blue-100 uppercase tracking-widest font-headline">Academic Suite</span>
        </div>
        <nav className="flex-1 px-4 space-y-2">
          <a className="flex items-center gap-3 px-4 py-3 text-slate-500 dark:text-slate-400 hover:text-blue-600 hover:bg-slate-200 dark:hover:bg-slate-800 transition-all duration-200 ease-in-out rounded-lg" href="#">
      ...
      <main className="md:ml-64 pb-20 md:pb-8">
        {/* TopAppBar */}
        <header className="bg-slate-50 dark:bg-slate-950 flex justify-between items-center px-6 py-4 w-full sticky top-0 z-40">
          <div className="flex items-center gap-4">
            <div className="w-10 h-10 rounded-full bg-primary-container flex items-center justify-center text-on-primary-container font-bold overflow-hidden">
              <img
                ...
                src="https://lh3.googleusercontent.com/aida-public/AB6AXuAQuxoqYdIseVKhMPGS3CqRutcUb4ivuNIWE8fTmSDLzEgUdzIGO-ELTNBn4yEEMcQMTNuo0HL2gyXRcIbcTh84KagKJHP998aKl3wYiQpa2LxdkfmlKSSk1SqEzsfTtjx4OESHnZctAnZLbUoQJEuo30Cqd2JuJdinN1aDeKf4XBFfMxIlKTtFqoiyVAJq74AHYhga6987vPDF6GaPgYRXUfEspIleZ0RUAe_nPASTWFgfG26cMLpAdBUJIWiVdLWUs2lygvGXbYIx"
              />
            </div>
            <h1 className="text-2xl font-bold tracking-tight text-blue-800 dark:text-blue-300 font-headline">Scholar Metric</h1>
          </div>
          <div className="flex items-center gap-4">
            <button className="p-2 rounded-full hover:bg-slate-200/50 transition-colors text-slate-600">
      ...
      <nav className="md:hidden fixed bottom-0 left-0 w-full z-50 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md flex justify-around items-center px-4 pb-4 pt-2 border-t border-slate-200/50 dark:border-slate-800/50">
        <a className="flex flex-col items-center justify-center text-slate-400 dark:text-slate-500 scale-90 duration-150 rounded-xl px-3 py-1" href="#">
